...
<html lang="es">
  <head>
    ...
    <style>
      ...
      .card {
        background-color: #05071a; /* Color de fondo de las cards */
        border: none;
        border-radius: 10px; /* Bordes redondeados */
        transition: transform 0.3s ease, box-shadow 0.3s ease; /* Efecto hover suave */
        flex: 1 1 calc(33.333% - 40px); /* 3 cards por fila en escritorio */
        max-width: calc(33.333% - 40px); /* 3 cards por fila en escritorio */
  ...
  <body>
    ...
    <div class="sidebar" id="sidebar">
      <img src="https://img.freepik.com/vector-gratis/circulo-azul-usuario-blanco_78370-4707.jpg" alt="Tu Nombre" />
      <nav>
        <ul>
      ...
      <footer class="footer">
        ...
        <section class="cta-contacto">
          <div class="container">
            ...
            <!-- Se añade el id "ctaForm" al formulario -->
